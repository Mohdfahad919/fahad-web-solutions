            ...
            <div className="grid md:grid-cols-2 gap-6">
              <AnimatedSection animation="slide-up">
                <div className="glass-card p-8 h-full">
                  <div className="icon-box w-14 h-14 mb-6"><Target className="w-6 h-6 text-accent" /></div>
              ...
              <AnimatedSection animation="slide-up" delay={100}>
                <div className="glass-card p-8 h-full">
                  <div className="icon-box w-14 h-14 mb-6"><Eye className="w-6 h-6 text-accent" /></div>
              ...
              {values.map((value, index) => (
                <AnimatedSection key={value.title} animation="slide-up" delay={index * 100}>
                  <div className="glass-card p-6 text-center h-full group">
                    <div className="icon-box w-14 h-14 mx-auto mb-5"><value.icon className="w-6 h-6 text-accent group-hover:text-white transition-colors" /></div>
            ...
            <AnimatedSection>
              <div className="bg-primary rounded-3xl p-10 sm:p-16 text-center relative overflow-hidden">
                ...
                <div className="relative z-10">
                  <h2 className="text-white mb-6">Let's Build Something Great Together</h2>
                  <p className="text-white/80 text-lg mb-8 max-w-2xl mx-auto">Ready to take your business online? We'd love to hear about your project.</p>
