          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8 mb-12 pb-10 border-b border-white/8">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <p className="text-white/50 leading-relaxed text-sm max-w-xs mb-5">
                Premium digital agency in Lucknow, India crafting high-converting websites for ambitious businesses across India.
              </p>
              <div className="flex gap-2">
                ...
                <a
                  href="https://www.facebook.com/fahadwebservice"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-white/6 flex items-center justify-center text-white/50 hover:text-accent hover:bg-white/10 transition-all duration-200"
                  aria-label="Facebook"
                ...
                <a
                  href="https://www.instagram.com/fahadwebservice"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-white/6 flex items-center justify-center text-white/50 hover:text-accent hover:bg-white/10 transition-all duration-200"
                ...
                <a
                  href="https://www.linkedin.com/company/fahad-webservice"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-9 h-9 rounded-lg bg-white/6 flex items-center justify-center text-white/50 hover:text-accent hover:bg-white/10 transition-all duration-200"
                  aria-label="LinkedIn"
